...
| **Demo / Hosted** | happypdf provisions Claude as judge/fixer with Gemini / GPT / Mistral / OLMo as peer reviewers | Per-conversion (scales with document size and review rounds) | Best quality |
