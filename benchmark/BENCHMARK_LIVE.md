...
|---|---|---|---|---|---|---|---|---|
| syllabus | clean, already accessible | 0 / 23 | 1 → 28p | 0 → 28p | — | 28 | converged | 113.21 |
| irs_schedule_c | dense tax form | 0 / 23 | 0 → 23p | — | — | 23 | converged | 7.25 |
| navy_bulletin | OCR'd historical scan, prose | 0 / 17 | 0 → 17p | — | — | 17 | converged | 7.99 |
