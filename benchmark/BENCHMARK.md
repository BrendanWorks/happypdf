...
|---|---|---|---|---|---|---|---|---|
| syllabus | clean, already accessible | 0 / 24 | 2 → 29p | 1 → 33p | 0 → 33p | 33 | converged | 2.57 |
| irs_schedule_c | dense tax form | 0 / 23 | 1 → 28p | 0 → 28p | — | 28 | converged | 1.37 |
| navy_bulletin | OCR'd historical scan, prose | 0 / 17 | 0 → 17p | — | — | 17 | converged | 0.94 |
