...
|---|---|---|---|---|---|---|---|---|
| syllabus | clean, already accessible | 0 / 23 | 2 → 28p | 1 → 32p | 0 → 32p | 32 | converged | 2.73 |
| irs_schedule_c | dense tax form | 0 / 23 | 1 → 28p | 0 → 28p | — | 28 | converged | 2.53 |
| navy_bulletin | OCR'd historical scan, prose | 0 / 17 | 0 → 17p | — | — | 17 | converged | 1.78 |
